...
2. Review the selected actor's current input and output schema before the first production run. The adapter in `scrape_dining.py` deliberately centralizes all field aliases.
